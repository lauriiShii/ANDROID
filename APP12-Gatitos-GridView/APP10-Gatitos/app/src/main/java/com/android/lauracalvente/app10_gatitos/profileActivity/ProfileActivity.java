package com.android.lauracalvente.app10_gatitos.profileActivity;
...
import com.android.lauracalvente.app10_gatitos.mainActivity.MainActivity;
import com.android.lauracalvente.app10_gatitos.R;
import com.android.lauracalvente.app10_gatitos.selectAvatarActivity.SelectAvatarActivity;
...
import com.android.lauracalvente.app10_gatitos.bdd.cats.Cat;
    ...
    private void addUser() {
        ...
        if (intent != null) {
            if (intent.hasExtra(Constantes.POSITION_USER)) {
                ...
                DataBaseUsers.getUsers().set(position, user);
            } else
                DataBaseUsers.getUsers().add(user);
        } else
            DataBaseUsers.getUsers().add(user);
    }
